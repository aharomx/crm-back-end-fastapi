...
class QuoteRepository:
    ...
    async def create(
        ...
        # Recalcular totales
        await self.__recalculate_totals(quote)
    ...
    async def get_by_id(self, quote_id:int) -> Optional[Quote]:
        """ Obtiene una cotización or ID con sus items """
    ...
    async def update(self, quote_id: int, update_data: dict) -> Optional[Quote]:
        ...
        # Recalcular totales si cambio de item
    ...
    async def remove_item(self, item_id:int) -> bool:
        ...
        # Recalcular totals de la cotización
        quote = await self.get_by_id(quote_id)
        if quote:
            await self._recalculate_totals(quote)
    ...
    async def __recalculate_totals(self, quote:Quote):
    ...
    async def get_stats(self, user_id: Optional[int]) -> dict:
        ...
        # Total en cotizaciones (suma totales)
